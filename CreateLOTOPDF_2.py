...
def addHeader():
    ...
    header_Field_Description_Height = numLines(
        data["Description"],
        header_Field_Description_LineLength,
        header_Field_Description_LineLimit,
    )
    ...
    header_Field_Facility_Height = numLines(
        data["Facility"],
        header_Field_Facility_LineLength,
        header_Field_Facility_LineLimit,
    )

    # Header Location
    header_Field_Location_LineLength = 26
    header_Field_Location_LineLimit = 5
    header_Field_Location_Height = numLines(
        data["Location"],
        header_Field_Location_LineLength,
        header_Field_Location_LineLimit,
    )
    ...
    pdf.line(
        header_Field_V_Line4,
        header_Field_H_Line1,
        header_Field_V_Line6,
        header_Field_H_Line1,
    )
    pdf.line(
        header_Field_V_Line4,
        header_Field_H_Line2,
        header_Field_V_Line6,
        header_Field_H_Line2,
    )
    pdf.line(
        header_Field_V_Line1,
        header_Field_H_Line3,
        header_Field_V_Line6,
        header_Field_H_Line3,
    )
    pdf.line(
    ...
    for line in range(header_Field_Description_Height):
        pdf.drawString(
            headerField_Description_X,
            header_Field_Row2_Text - (line * header_Field_Body_LineSpacing),
            splitText(
                data["Description"],
                header_Field_Description_LineLength,
                header_Field_Description_LineLimit,
    ...
    for line in range(header_Field_Facility_Height):
        pdf.drawString(
            headerField_Facility_X,
            header_Field_Row3_Text - (line * header_Field_Body_LineSpacing),
            splitText(
                data["Facility"],
                header_Field_Facility_LineLength,
                header_Field_Facility_LineLimit,
    ...
    pdf.drawString(
        headerField_Revision_X,
        header_Field_Row3_Text,
        data["Revision"][0:header_Field_Revision_LineLength],
    )
    pdf.setFont("Inter", 9)
    ...
    for line in range(len(header_Field_Address)):
        pdf.drawString(
            header_Field_AddressBlock_X,
            header_Field_AddressBlock_Y - (line * header_Field_Address_LineSpacing),
