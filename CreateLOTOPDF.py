...
shutdownField_Row1_Offset = (
    numLines(
        shutdownField_Description,
        shutdownField_Description_LineLength,
        shutdownField_Description_MaxLines,
    )
    * shutdownField_Description_LineSpacing
    + 2
)  # Shutdown Sequence Instrutions
...
restartField_Row1_Offset = (
    numLines(
        restartField_Description,
        restartField_Description_LineLength,
        restartField_Description_MaxLines,
    )
    * restartField_Description_LineSpacing
    + 2
)  # Restart Sequence Instrutions
...
def addHeader():
    ...
    for line in range(len(headerField_Address)):
        pdf.drawString(
            headerField_AddressBlock_X,
            headerField_AddressBlock_Y - (line * headerField_AddressBlock_LineSpacing),
            headerField_Address[line],
        )
        if line > 3:
...
def addMachineInfo():
    ...
    # Horizontal Lines
    pdf.line(
        machineField_V_Line1,
        machineField_H_Line1,
        machineField_V_Line3,
        machineField_H_Line1,
    )
    pdf.line(
        machineField_V_Line1,
        machineField_H_Line2,
        machineField_V_Line2,
        machineField_H_Line2,
    )
    pdf.line(
        machineField_V_Line2,
    ...
    pdf.drawImage(
        machineField_LockImage,
        machineField_LockImage_X,
        machineField_LockImage_Y,
        machineField_LockImage_Width,
        machineField_LockImage_Height,
    )

    # Place Square
    pdf.line(
        machineField_Square_Left,
        machineField_Square_Top,
        machineField_Square_Right,
        machineField_Square_Top,
    )
    pdf.line(
        machineField_Square_Left,
...
def addShutdownInfo():
    ...
    # Horizontal Lines
    pdf.line(
        shutdownField_V_Line1,
        shutdownField_H_Line1,
        shutdownField_V_Line2,
        shutdownField_H_Line1,
    )
    pdf.line(
        shutdownField_V_Line1,
        shutdownField_H_Line2,
        shutdownField_V_Line2,
        shutdownField_H_Line2,
    )
    pdf.line(
        shutdownField_V_Line1,
        shutdownField_H_Line3,
        shutdownField_V_Line2,
        shutdownField_H_Line3,
    )
    # Vertical Lines
    ...
    # Add Red
    pdf.drawImage(
        shutdownField_Background,
        shutdownField_V_Line1,
        shutdownField_H_Line2,
        shutdownField_Width,
        shutdownField_RowSpacing,
    )

    # Add Shutdown Field Titles / Descriptions
    pdf.setFillColorRGB(
        shutdownField_Title_Color[0],
        shutdownField_Title_Color[1],
    ...
    for line in range(
        ...
        pdf.drawCentredString(
            shutdownField_Column1_Text,
            shutdownField_Row2_Text - (line * shutdownField_Description_LineSpacing),
            splitText(
                shutdownField_Description,
                shutdownField_Description_LineLength,
                shutdownField_Description_MaxLines,
...
def addSourceTitles(newStartingYPos=sourceTitleField_H_Line1):
    ...
    # Horizontal Lines
    pdf.line(
        sourceTitleField_V_Line1,
        sourceTitleField_H_Line1,
        sourceTitleField_V_Line7,
        sourceTitleField_H_Line1,
    )
    pdf.line(
        sourceTitleField_V_Line1,
        sourceTitleField_H_Line2,
        sourceTitleField_V_Line7,
        sourceTitleField_H_Line2,
    )
    # Vertical Lines
    ...
    # Vertical Dividers
    pdf.line(
        sourceTitleField_V_Line2,
        sourceTitleField_H_Line1,
        sourceTitleField_V_Line2,
        sourceTitleField_H_Line2,
    )
    pdf.line(
        sourceTitleField_V_Line3,
        sourceTitleField_H_Line1,
        sourceTitleField_V_Line3,
        sourceTitleField_H_Line2,
    )
    pdf.line(
        sourceTitleField_V_Line4,
        sourceTitleField_H_Line1,
        sourceTitleField_V_Line4,
        sourceTitleField_H_Line2,
    )
    pdf.line(
        sourceTitleField_V_Line5,
        sourceTitleField_H_Line1,
        sourceTitleField_V_Line5,
        sourceTitleField_H_Line2,
    )
    pdf.line(
        sourceTitleField_V_Line6,
        sourceTitleField_H_Line1,
        sourceTitleField_V_Line6,
        sourceTitleField_H_Line2,
    )
...
def addSource(import_bottom, import_height):
    ...
    sourceField_Column3_Image = sourceField_V_Line3 + (
        sourceField_ImageBlock_Width / 2
    )  # Still need to subtract half the image width but that needs to happen after resizing
    sourceField_Column4_Text = sourceTitleField_Column4_Text
    sourceField_Column5_Text = sourceTitleField_Column5_Text
    sourceField_Column6_Image = sourceField_V_Line6 + (
        sourceField_ImageBlock_Width / 2
    )  # Still need to subtract half the image width but that needs to happen after resizing
    ...
    match source_value.get("EnergySource", "Other"):
        case "Electric":
            pdf.drawCentredString(
                sourceField_Column1_Text,
                sourceField_Middle_Text + (sourceField_EnergySource_LineSpacing / 2),
                source_value.get("EnergySource", sourceField_BlankText),
            )
            pdf.drawCentredString(
                sourceField_Column1_Text,
                sourceField_Middle_Text - (sourceField_EnergySource_LineSpacing / 2),
                source_value.get("VOLTS", sourceField_BlankText_V) + " V",
            )
        case "Natural Gas" | "Steam" | "Hydraulic" | "Regrigerant":
            pdf.drawCentredString(
                sourceField_Column1_Text,
                sourceField_Middle_Text + (sourceField_EnergySource_LineSpacing / 2),
                source_value.get("EnergySource"),
            )
            pdf.drawCentredString(
                sourceField_Column1_Text,
                sourceField_Middle_Text - (sourceField_EnergySource_LineSpacing / 2),
                source_value.get("S1_PSI", sourceField_BlankText_PSI) + " PSI",
            )
        case "Chemical":
            pdf.drawCentredString(
                sourceField_Column1_Text,
                sourceField_Middle_Text + sourceField_EnergySource_LineSpacing,
                source_value.get("EnergySource", sourceField_BlankText),
            )
            pdf.drawCentredString(
                sourceField_Column1_Text,
                sourceField_Middle_Text,
                source_value.get("ChemicalName", sourceField_BlankText),
            )
            pdf.drawCentredString(
                sourceField_Column1_Text,
                sourceField_Middle_Text - sourceField_EnergySource_LineSpacing,
                source_value.get("PSI", sourceField_BlankText_PSI) + " PSI",
            )
        case "Gravity":
            pdf.drawCentredString(
                sourceField_Column1_Text,
            ...
            pdf.drawCentredString(
                sourceField_Column1_Text,
                sourceField_Middle_Text - (sourceField_EnergySource_LineSpacing / 2),
                source_value.get("LBS", sourceField_BlankText_LBS) + " lbs",
            )
        case "Thermal":
            pdf.drawCentredString(
                sourceField_Column1_Text,
            ...
            pdf.drawCentredString(
                sourceField_Column1_Text,
                sourceField_Middle_Text - (sourceField_EnergySource_LineSpacing / 2),
                source_value.get("TEMP", sourceField_BlankText_TEMP) + " F",
            )
        case "Other":
            pdf.drawCentredString(
                sourceField_Column1_Text,
                sourceField_Middle_Text + (sourceField_EnergySource_LineSpacing / 2),
                sourceField_BlankText,
            )
            pdf.drawCentredString(
                sourceField_Column1_Text,
                sourceField_Middle_Text - (sourceField_EnergySource_LineSpacing / 2),
    ...
    if "Device" in source_value:
        deviceLines = splitText(
            source_value.get("Device", sourceField_BlankText),
            sourceField_CharactersPerLine,
            sourceField_Device_MaxLines,
        )
    ...
    if "Description" in source_value:
        descriptionLines = splitText(
            source_value.get("Description", sourceField_BlankText),
            sourceField_CharactersPerLine,
            sourceField_Description_MaxLines,
        )
    ...
    if len(device) % 2 == 1:
        for line in range(len(device)):
            pdf.drawCentredString(
                ...
                sourceField_Middle_Text
                + (math.floor(len(device) / 2) * sourceField_Device_LineSpacing)
    ...
    if "IsolationMethod" in source_value:
        sourceField_IsolationMethod_NumLines = numLines(
            source_value.get("IsolationMethod", ""),
            sourceField_CharactersPerLine,
            sourceField_IsolationMethod_MaxLines,
        )
        sourceField_IsolationMethod_Lines = splitText(
            source_value.get("IsolationMethod", ""),
            sourceField_CharactersPerLine,
            sourceField_IsolationMethod_MaxLines,
        )
    ...
    if "VerificationMethod" in source_value:
        sourceField_VerificationMethod_NumLines = numLines(
            source_value.get("VerificationMethod", ""),
            sourceField_CharactersPerLine,
            sourceField_VerificationMethod_MaxLines,
        )
        sourceField_VerificationMethod_Lines = splitText(
            source_value.get("VerificationMethod", ""),
            sourceField_CharactersPerLine,
            sourceField_VerificationMethod_MaxLines,
        )
    ...
    pdf.drawImage(
        source_value.get("IsolationPoint", sourceField_DefaultImage),
        sourceField_Column3_Image - (sourceField_IsolationPoint_NewWidth / 2),
        sourceField_Middle_Image - (sourceField_IsolationPoint_NewHeight / 2),
        sourceField_IsolationPoint_NewWidth,
        sourceField_IsolationPoint_NewHeight,
    )

    # Verification Device
    (
        sourceField_VerificationDevice_NewHeight,
        sourceField_VerificationDevice_NewWidth,
    ) = resize_image(
        source_value.get("VerificationDevice", sourceField_DefaultImage),
        sourceField_VerificationDevice_MaxHeight,
        sourceField_VerificationDevice_MaxWidth,
    )
    pdf.drawImage(
        source_value.get("VerificationDevice", sourceField_DefaultImage),
        sourceField_Column6_Image - (sourceField_VerificationDevice_NewWidth / 2),
        sourceField_Middle_Image - (sourceField_VerificationDevice_NewHeight / 2),
        sourceField_VerificationDevice_NewWidth,
        sourceField_VerificationDevice_NewHeight,
    )
...
def addRestartInfo(bottom):
    ...
    # Horizontal Lines
    pdf.line(
        restartField_V_Line1,
        restartField_H_Line1,
        restartField_V_Line2,
        restartField_H_Line1,
    )
    pdf.line(
        restartField_V_Line1,
        restartField_H_Line2,
        restartField_V_Line2,
        restartField_H_Line2,
    )
    pdf.line(
        restartField_V_Line1,
        restartField_H_Line3,
        restartField_V_Line2,
        restartField_H_Line3,
    )
    # Vertical Lines
    ...
    # Add Green
    pdf.drawImage(
        restartField_Background,
        restartField_V_Line1,
        restartField_H_Line2,
        restartField_Width,
        restartField_RowSpacing,
    )

    # Add Restart Field Titles / Descriptions
    pdf.setFillColorRGB(
        restartField_Title_Color[0],
        restartField_Title_Color[1],
    ...
    for line in range(
        ...
        pdf.drawCentredString(
            restartField_Column1_Text,
            restartField_Row2_Text - (line * restartField_Description_LineSpacing),
            splitText(
                restartField_Description,
                restartField_Description_LineLength,
                restartField_Description_MaxLines,
...
def addFooter(bottom):
    ...
    footerField_Description = (
        "The signatures below indicate that the lockout procedure covered on this sheet has been prepared by Cardinal Compliance and approved by "
        + data[fileName].get("ApprovedBy_1", "_" * 25)
        + "."
    )
    ...
    footerField_Row1_Offset = (
        numLines(
            footerField_Description,
            footerField_Description_LineLength,
            footerField_Description_MaxLines,
        )
        * footerField_Description_LineSpacing
        + 2
    )  # Footer Description

    footerField_PreparedBy_Lines = numLines(
        data[fileName].get("PreparedBy", "Cardinal Compliance Consultants"),
        footerField_SubTitle_LineLength,
        footerField_SubTitle_MaxLines,
    )
    footerField_ApprovedBy_Lines = numLines(
        data[fileName].get("ApprovedBy_2", "Cardinal Compliance Consultants"),
        footerField_SubTitle_LineLength,
        footerField_SubTitle_MaxLines,
    )
    ...
    pdf.drawString(
        footerField_Column1_Text,
        footerField_Row1_Text,
        "Lockout Procedure Approval Data:",
    )
    ...
    for line in range(
        ...
        pdf.drawString(
            footerField_Column1_Text,
            footerField_Row2_Text - (line * footerField_Description_LineSpacing),
            splitText(
                footerField_Description,
                footerField_Description_LineLength,
                footerField_Description_MaxLines,
    ...
    pdf.line(
        footerField_Column2_Text,
        footerField_Row3_Text,
        (footerField_Column3_Text - footerField_RowSpacing),
        footerField_Row3_Text,
    )
    pdf.drawString(footerField_Column3_Text, footerField_Row3_Text, "Approved by:")
    pdf.line(
        footerField_Column4_Text,
        footerField_Row3_Text,
        (footerField_Column5_Text - footerField_RowSpacing),
        footerField_Row3_Text,
    )
...
for device_name, device_data in data.items():
    if "Sources" in device_data:  # Check if the "Sources" key exists
        ...
        for source_name, source_value in sources.items():
            ...
            deviceHeight = (
                numLines(
                    source_value.get("Device", ""),
                    sourceField_CharactersPerLine,
                    sourceField_Device_MaxLines,
                )
                + 3
                + numLines(
                    source_value.get("Description", ""),
                    sourceField_CharactersPerLine,
                    sourceField_Description_MaxLines,
                )
            )
            IsolationMethodHeight = numLines(
                source_value.get("IsolationMethod", ""),
                sourceField_CharactersPerLine,
                sourceField_IsolationMethod_MaxLines,
            )
            verificationMethodHeight = numLines(
                source_value.get("VerificationMethod", ""),
                sourceField_CharactersPerLine,
                sourceField_VerificationMethod_MaxLines,
            )
